        ...
        {step === 2 && (
          <div>
            ...
            <div className="mb-3">
              ...
              <input className="form-control" placeholder="Jane Smith" value={name} onChange={(e) => setName(e.target.value)} />
            </div>
            <div className="mb-3">
              <label className="form-label">Work Email *</label>
              <input className="form-control" placeholder="jsmith@naba.org" value={email} onChange={(e) => setEmail(e.target.value)} />
            </div>
